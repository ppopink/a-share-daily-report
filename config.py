...
USE_MARKET_CONTEXT_CACHE = True
USE_MARKET_CONTEXT_API = True
USE_EVENT_API = True
USE_MARGIN_API = True
USE_LHB_API = True
MARKET_CONTEXT_LOOKBACK_DAYS = 10
EVENT_LOOKBACK_DAYS = 14
MARGIN_LOOKBACK_DAYS = 5
LHB_LOOKBACK_DAYS = 10
MARKET_CONTEXT_API_TIMEOUT = 6
MARKET_CONTEXT_API_RETRIES = 1
MARKET_CONTEXT_MAX_WORKERS = 4
MARKET_CONTEXT_TOTAL_TIMEOUT = 35
MARKET_CONTEXT_SCORE_LIMIT = 8
