...
def save_results(df, trade_date=None, mode=None, write_legacy=True, update_history=True):
    ...
    save_cols = [
        ...
        "context_score", "event_score", "event_count", "event_note", "event_titles",
        "margin_score", "margin_balance_change_pct", "margin_net_buy", "margin_note",
        "lhb_score", "lhb_count", "lhb_net_buy", "lhb_note", "context_note",
        "selection_reason", "watch_reason",
        "buy_action", "buy_trigger", "buy_avoid_rules",
        "max_open_gap_pct", "max_buy_price", "pullback_buy_price", "invalid_below_price",
